...
In this case I passing in samples of my own misspellings: feild -> field, and paralel -> parallel. After passing in a few samples I give the API a sample that does not have its Corrected Text finished. It will then return the anwnser. The returned Corrected Text will have the typos fixed! Amazing!
